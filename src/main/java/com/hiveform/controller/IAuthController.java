...
public interface IAuthController {
    ...
    ResponseEntity<ApiResponse<Void>> register(RegisterRequest registerRequestDto, HttpServletRequest request);
    ResponseEntity<ApiResponse<Void>> verifyEmail(String email, String code, HttpServletRequest request);
    ResponseEntity<ApiResponse<AuthResponse>> googleCallback(String code, String state, HttpServletRequest request);
